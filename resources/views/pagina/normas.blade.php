    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-4 mb-3">
                <div class="card">
                    <img src="{{ asset('blog/img/responsabilidad_1.jpg') }}" class="card-img-top" alt="sistemas-de-gestion">
                    <div class="card-body">
                        <h5 class="card-title">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <img src="{{ asset('blog/img/seguridad_1.jpg') }}" class="card-img-top" alt="sistemas-de-gestion">
                    <div class="card-body">
                        <h5 class="card-title">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <img src="{{ asset('blog/img/alimentaria_1.jpg') }}" class="card-img-top" alt="sistemas-de-gestion">
                    <div class="card-body">
                        <h5 class="card-title">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <img src="{{ asset('blog/img/ambiental_1.jpg') }}" class="card-img-top" alt="sistemas-de-gestion">
                    <div class="card-body">
                        <h5 class="card-title">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <img src="{{ asset('blog/img/calidad_1.jpg') }}" class="card-img-top" alt="sistemas-de-gestion">
                    <div class="card-body">
                        <h5 class="card-title">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <img src="{{ asset('blog/img/soborno_1.jpg') }}" class="card-img-top" alt="sistemas-de-gestion">
                    <div class="card-body">
                        <h5 class="card-title">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <img src="{{ asset('blog/img/trabajo_1.jpg') }}" class="card-img-top" alt="sistemas-de-gestion">
                    <div class="card-body">
                        <h5 class="card-title">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <img src="{{ asset('blog/img/vial_1.jpg') }}" class="card-img-top" alt="sistemas-de-gestion">
                    <div class="card-body">
                        <h5 class="card-title">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <img src="{{ asset('blog/img/energetica_1.jpg') }}" class="card-img-top" alt="sistemas-de-gestion">
                    <div class="card-body">
                        <h5 class="card-title">
