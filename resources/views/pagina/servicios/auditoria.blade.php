    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12 mx-auto">
                <h3 class="mb-5">AUDITORIA INTERNA</h2>
            </div>
        </div>
    </div>
</header>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-5 mb-3">
                <img src="{{ asset('../blog/img/auditoria.jpg') }}" alt="ost auditoria interna" class="img-fluid">
            </div>

            <div class="col-md-7 mb-3 mt-3">
                <p class="text-justify">Nuestro servicio de auditoria consiste en una revisión de su Sistema de Gestión a través de la verificación
                    ...
                    con las normativas internacionales.</p>
            </div>
        </div>
    </div>
</section>
