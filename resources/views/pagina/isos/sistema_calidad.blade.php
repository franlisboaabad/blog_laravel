...
@section('title','-NORMAS/SISTEMA_CALIDAD')
@section('contenido')
<div class="container">
    <div class="row mt-5">
        <div class="col-md-8 mb-3">
            <div class="card">
                <img src="{{ asset('blog/img/calidad.jpg') }}" class="card-img-top"
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-justify">El Sistema de Gestión de Calidad ISO 9001 
                      ...
                      <div class="container">
                      <ul>
                          <li><h4>Orientación al cliente</h4></li>
                          <p style="text-align:justify;">Satisfacer las necesidades del cliente es el objetivo principal
                          ...
                          <li><h4>Compromiso de las personas</h4></li>
                          ...
                          <li><h4>Enfoque basado en procesos</h4></li>
                          ...
                          <li><h4>Toma de decisiones basada en evidencias</h4></li>
                          ...
                          <li><h4>Gestión de relaciones</h4></li>
