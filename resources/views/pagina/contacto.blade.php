...
<div class="container my-5">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <p>Para mayor información debe de llenar los campos del formulario y un representante se pondrá en contacto.</p>
            <form action="{{ route('contacto_email') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="mensaje" rows="6" placeholder="Escribe tu mensaje aqui..."></textarea>
                </div>

                <button class="btn btn btn-success" style=" width: 300px; border-radius:50px">ENVIAR MENSAJE</button>
