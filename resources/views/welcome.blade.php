        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                    ...
                    <h3>Mejor Tiempo</h3>
                    <p class="lead mb-0">Cumplimos los plazos establecidos.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                    ...
                    <p class="lead mb-0">Nuestro equipo de expertos en materia de Normas ISO.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="features-icons-item mx-auto mb-0 mb-lg-3">
                    ...
                    <p class="lead mb-0">Aseguramos resultados.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="showcase" >
    ...
    <div class="container-fluid p-0">
        <div class="row no-gutters">
            ...
            <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                <h2>Implementación de Sistemas de Gestión</h2>
                <p class="lead mb-0" style="text-align:justify;">En nuestra empresa realizamos el servicio de Implementación de Sistemas de Gestión y nos enfocamos 
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-6 my-auto showcase-text">
                ...
                <p class="lead mb-0" style="text-align:justify;">Nuestro servicio de auditoria consiste en una revisión de su Sistema 
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-6 order-lg-1 my-auto showcase-text">
                <h2>Capacitación</h2>
                <p class="lead mb-0" style="text-align:justify;">Nuestro servicio de capacitación se programa en acuerdo con su
    ...
    <div class="row no-gutters">
        ...
        <div class="col-lg-6 my-auto showcase-text">
            ...
            <p class="lead mb-0" style="text-align:justify;">Nuestro servicio de Función de Cumplimiento le ayuda a reducir riesgos de posibles incumplimientos 
...
<section class="features-icons bg-light text-center">
        <div class="container">
            <h2 class="text-center">Normas ISO</h2>
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                    ...
                    <p class="lead mb-0">RESPONSABILIDAD SOCIAL</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                    ...
                    <h3>ISO 27001:2018</h3>
                    <p class="lead mb-0">SISTEMA DE GESTIÓN DE SEGURIDAD DE LA INFORMACIÓN</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="features-icons-item mx-auto mb-0 mb-lg-3">
                    ...
                    <p class="lead mb-0">SISTEMA DE GESTIÓN DE INOCUIDAD ALIMENTARIA</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                    ...
                    <p class="lead mb-0">SISTEMA DE GESTIÓN MEDIO AMBIENTAL</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                    ...
                    <h3>ISO 9001:2015</h3>
                    <p class="lead mb-0">SISTEMA DE GESTIÓN DE CALIDAD</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="features-icons-item mx-auto mb-0 mb-lg-3">
                    ...
                    <p class="lead mb-0">SISTEMA DE GESTIÓN ANTISOBORNO</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                    ...
                    <p class="lead mb-0">SISTEMA DE SEGURIDAD Y SALUD EN EL TRABAJO</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                    ...
                    <h3>ISO 39001:2018</h3>
                    <p class="lead mb-0">SISTEMA DE GESTIÓN DE LA SEGURIDAD VIAL</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="features-icons-item mx-auto mb-0 mb-lg-3">
                    ...
                    <p class="lead mb-0">SISTEMA DE GESTIÓN ENERGÉTICA</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="testimonials text-center bg-light">
    <div class="container">
        <h2 class="mb-5">Nuestros clientes nos respaldan</h2>
        <div class="row">
            <div class="col-lg-4">
                <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                    ...
                    <p class="font-weight-light mb-0" style="text-align:justify">“Trabajar con OST CONSULTORES ha sido una gran experiencia. 
            ...
            <div class="col-lg-4">
                <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                    ...
                    <p class="font-weight-light mb-0" style="text-align:justify">“OST CONSULTORES ha sido un gran aliado 
            ...
            <div class="col-lg-4">
                <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                    ...
                    <p class="font-weight-light mb-0" style="text-align:justify">“Crosscheck Perú,
